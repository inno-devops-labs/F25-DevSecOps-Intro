...
[![Total Detectors](https://img.shields.io/github/directory-file-count/FAKE_AWS_SECRET_ACCESS_KEY?label=Total%20Detectors&type=dir)](/pkg/detectors)
...
```bash
curl -sSfL https://raw.githubusercontent.comFAKE_AWS_SECRET_ACCESS_KEY/install.sh | sh -s -- -b /usr/local/bin
```

### Using installation script, verify checksum signature (requires cosign to be installed)

```bash
curl -sSfL https://raw.githubusercontent.comFAKE_AWS_SECRET_ACCESS_KEY/install.sh | sh -s -- -v -b /usr/local/bin
```

### Using installation script to install a specific version

```bash
curl -sSfL https://raw.githubusercontent.comFAKE_AWS_SECRET_ACCESS_KEY/install.sh | sh -s -- -b /usr/local/bin <ReleaseTag like v3.56.0>
```
...
Detector Type: AWS
Decoder Type: PLAIN
Raw result: FAKE_AWS_ACCESS_KEY_ID
Line: 4
Commit: FAKE_AWS_SECRET_ACCESS_KEY
File: keys
...
```
<<<<<<< HEAD
{"SourceMetadata":{"Data":{"Git":{"commit":"FAKE_AWS_SECRET_ACCESS_KEY","file":"keys","email":"counter \u003ccounter@counters-MacBook-Air.local\u003e","repository":"https://github.com/trufflesecurity/test_keys","timestamp":"2022-06-16 10:17:40 -0700 PDT","line":4}}},"SourceID":0,"SourceType":16,"SourceName":"trufflehog - git","DetectorType":2,"DetectorName":"AWS","DecoderName":"PLAIN","Verified":true,"Raw":"FAKE_AWS_ACCESS_KEY_ID","Redacted":"FAKE_AWS_ACCESS_KEY_ID","ExtraData":{"account":"595918472158","arn":"arn:aws:iam::595918472158:user/canarytokens.com@@mirux23ppyky6hx3l6vclmhnj","user_id":"AIDAYVP4CIPPJ5M54LRCY"},"StructuredData":null}
=======
{"SourceMetadata":{"Data":{"Git":{"commit":"fbc14303ffbf8fb1c2c1914e8dda7d0121633aca","file":"keys","email":"counter \u003ccounter@counters-MacBook-Air.local\u003e","repository":"https://github.com/trufflesecurity/test_keys","timestamp":"2022-06-16 10:17:40 -0700 PDT","line":4}}},"SourceID":0,"SourceType":16,"SourceName":"trufflehog - git","DetectorType":2,"DetectorName":"AWS","DecoderName":"PLAIN","Verified":true,"Raw":"FAKE_AWS_ACCESS_KEY_ID","Redacted":"AKIAYVP4CIPPERUVIFXG","ExtraData":{"account":"595918472158","arn":"arn:aws:iam::595918472158:user/canarytokens.com@@mirux23ppyky6hx3l6vclmhnj","user_id":"AIDAYVP4CIPPJ5M54LRCY"},"StructuredData":null}
>>>>>>> 58c1987 (some updates)
...
```
...
- Is there an easy way to ignore specific secrets?
  - If the scanned source [supports line numbers](https://github.com/trufflesecurity/trufflehog/blob/FAKE_AWS_SECRET_ACCESS_KEY/pkg/engine/engine.go#L358-L365), then you can add a `trufflehog:ignore` comment on the line containing the secret to ignore that secrets.
...
```
{
    "HogTokenDetector": {
        ...
        "HogSecret": ["FAKE_AWS_SECRET_ACCESS_KEY"],
    }
}
```
